            ...
            <div class="row">
                <form ng-submit="addUserProfile(ab)">
                    ...
                    <div class="col-lg-8">
                        ...
                        <input class="form-control" placeholder="Enter First Name" type="text" ng-model="ab.graduateDate" value="2007-09-23 10:10:10.0" required min="1" /><br>
                        ...
                        <input class="form-control" placeholder="Enter Email" type="text" ng-model="ab.joinDate" value="2007-09-23 10:10:10.0" required min="1" /><br>
                        ...
                        <input class="form-control" placeholder="Enter Email" type="text" ng-model="ab.professionalCertification" value="false" required min="1" /><br>
                        <input class="form-control" placeholder="Enter First Name" type="text" ng-model="ab.overseaWorkingExperience" value="false" required min="1" /><br>
                        ...
                        <input class="form-control" placeholder="Enter Last Name" type="text" ng-model="ab.gender" value="false" required min="1" /><br>
                        <input class="form-control" placeholder="Enter Phone" type="text" ng-model="ab.needTracking" value="false" required min="1" /><br>
