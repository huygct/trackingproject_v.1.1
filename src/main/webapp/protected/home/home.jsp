                ...
                <form name="myForm" novalidate>
                    <div class="col-lg-8">
                        <table class="table table-bordered table-striped" >
                            ...
                            <tr>
                                <th>Graduate Date</th>
                                <th><input class="form-control" placeholder="Enter Graduate Date" type="date" ng-model="ab.graduateDate" value="" required min="1" /></th>
                            </tr>
                            <tr>
                                <th>Final Study Result</th>
                                <th><input class="form-control" placeholder="Enter Final Study Result" type="number" step="0.01" ng-model="ab.finalStudyResult" value="0" required min="0" /></th>
                            </tr>
                            <tr>
                                <th>Toeic</th>
                                <th><input class="form-control" placeholder="Enter Toeic" type="number" ng-model="ab.toeic" value="0" required min="0" /></th>
                            </tr>
                            <tr>
                                <th>Join Date</th>
                                <th><input class="form-control" placeholder="Enter Join Date" type="date" ng-model="ab.joinDate" value="" required min="1" /></th>
                            </tr>
                            <tr>
                                <th>Work Role</th>
                                <th><input class="form-control" placeholder="Enter Work Role" type="text" ng-model="ab.workRole" value="" /></th>
                            </tr>
                            <tr>
                                <th>Experience Years</th>
                                <th><input class="form-control" placeholder="Enter Experience Years" type="number" step="0.01" ng-model="ab.experienceYears" value="0" required min="0" /></th>
                            </tr>
                            <tr>
                                <th>Experience Years In Current Role</th>
                                <th><input class="form-control" placeholder="Enter Experience Years InCurrent Role" type="number" step="0.01" ng-model="ab.experienceYearsInCurrentRole" value="0" required min="0" /></th>
                            </tr>
                            <tr>
                                <th>Professional Certification</th>
                                <th><input class="form-control" placeholder="Enter Professional Certification" type="checkbox" ng-model="ab.professionalCertification" value="false" /></th>
                            </tr>
                            <tr>
                                <th>Oversea Working Experience</th>
                                <th><input class="form-control" placeholder="Enter Oversea Working Experience" type="checkbox" ng-model="ab.overseaWorkingExperience" value="false" /></th>
                            </tr>
                            <tr>
                                <th>Police Clearance Status</th>
                                <th><input class="form-control" placeholder="Enter Police Clearance Status" type="text" ng-model="ab.policeClearanceStatus" value="" required /></th>
                            </tr>
                            <tr>
                                <th>CV</th>
                                <th><input class="form-control" placeholder="Enter cv Url" type="text" ng-model="ab.cvUrl" value="" required /></th>
                            </tr>
                            <tr>
                                <th>Image User</th>
                                <th><input class="form-control" placeholder="Enter Image User" type="text" ng-model="ab.imageUser" value="" /></th>
                            </tr>
                            <tr>
                                <th>Place</th>
                            ...
                            <tr>
                                <th>Gender</th>
                                <th>
                                    <input class="form-control" type="checkbox" ng-model="ab.gender" value="false" /></th>
                                </th>
                            </tr>
                            <tr>
                                <th>Need Tracking</th>
                                <th><input class="form-control" placeholder="Enter needTracking" type="checkbox" ng-model="ab.needTracking" value="false" /></th>
                            </tr>
                            <tr>
                                <th>Skype Id</th>
                                <th><input class="form-control" placeholder="Enter Skype Id" type="text" ng-model="ab.skypeId" value="" required /></th>
                            </tr>
                            <tr>
                                <th>Ip Address</th>
                                <th><input class="form-control" placeholder="Enter Ip Address" type="text" ng-model="ab.ipAddress" value="" /></th>
                            </tr>
                            <tr>
                                <th>General Status</th>
                                <th><input class="form-control" placeholder="Enter General Status" type="text" ng-model="ab.generalStatus" value="" /></th>
                            </tr>
                        </table>
